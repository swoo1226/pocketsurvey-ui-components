# 0.7.3-beta (2021.09.28)

- 버튼 컴포넌트 theme props 이름을 mode로 변경
  - styled component에 있는 theme과 이름이 충돌
- 버튼 컴포넌트 IE에서 width 값이 100%로 나오는 버그 수정

# 0.7.22 (2021.09.28)

- 차트 가독성
  - barHorizontalSeperated legend 세로 스크롤

# 0.7.21 (2021.09.27)

- 차트 가독성
  - barHorizontalStacked max값 지정
  - tooltop (소수점 첫째자리)%
...
- 마지막 인덱스가 6일 때 파이 차트 슬라이스가 7개로 나오는 버그 수정

# 0.6.92 (2021.09.01)

- sandbox 전체선택 및 전체선택 해제 버튼 background 추가

# 0.6.91 (2021.09.01)

- 파이 차트 시리즈를 최대 6개 까지만 렌더하도록 수정. 나머지는 '그 외'로 처리
- 파이 차트 레전드 추가
